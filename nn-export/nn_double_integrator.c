...
static const float pi_max = 0.05;
...
// static const float Rsense = 3.0;
// static const float barrier_gamma = 0.01;//0.005;
// static const float barrier_kp = 0.0075;//0.005;
// static const float barrier_kv = 0.0075;//0.005;
...
// 	// Barrier:
// 	float b[2] = {0, 0};
// 	b[0] = -barrier_kv * (v[0] + barrier_kp * barrier_grad_phi[0]) - barrier_kp * barrier_grad_phi[0] - barrier_kv * barrier_grad_phi_dot[0];
// 	b[1] = -barrier_kv * (v[1] + barrier_kp * barrier_grad_phi[1]) - barrier_kp * barrier_grad_phi[1] - barrier_kv * barrier_grad_phi_dot[1];

// 	// // Adaptive Scaling
// 	float alpha = 1.0;
// 	if (barrier_alpha_condition) {
// 		float bnorm = sqrtf(powf(v[0] + barrier_kp * barrier_grad_phi[0], 2) + powf(v[1] + barrier_kp * barrier_grad_phi[1], 2));
...
// 	float alpha2 = 1.0;
// 	if (temp1_norm > 0) {
// 		alpha2 = fminf(1.0f, max_a / temp1_norm);
// 	}
// 	temp1[0] *= alpha2;
// 	temp1[1] *= alpha2;
