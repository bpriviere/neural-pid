...
./multi-robot-trajectory-planning/build/libMultiRobotPlanning/ecbs -i test.yaml -o multi-robot-trajectory-planning/examples/ground/output/discreteSchedule.yaml -w 1.3
