...
class SingleIntegratorVelSensingParam(Param):
	def __init__(self):
		...
		self.il_train_model_fn = '../results/singleintegrator_vel_sensing/il_current.pt'
		...
		# self.datadict["012"] = 100000 #250000 #self.il_n_data
		# self.datadict["032"] = 100000 #250000 #self.il_n_data
